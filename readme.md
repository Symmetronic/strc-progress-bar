[![Build Status](https://github.com/Symmetronic/strc-progress-bar/workflows/build/badge.svg?branch=main)](https://github.com/Symmetronic/strc-progress-bar/actions?query=workflow%3Abuild+branch%3Amain) [![GitHub License](https://img.shields.io/github/license/Symmetronic/strc-progress-bar)](https://github.com/Symmetronic/strc-progress-bar/blob/main/LICENSE) [![NPM Version](https://img.shields.io/npm/v/strc-progress-bar)](https://www.npmjs.com/package/strc-progress-bar) [![Monthly Downloads](https://img.shields.io/npm/dm/strc-progress-bar)](https://npmcharts.com/compare/strc-progress-bar?minimal=true)
